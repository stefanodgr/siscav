      ...
      <div id='box_login' class='back_log'>
        <div id='box_datos'>
          <div class='div_login_inp'>
            ...
            <input type="text" id="id_inp_usuario" class='inp_login' placeholder="Carné" value=''>
          </div><br>
          <div class='div_login_inp'>
            <div class='div_login_ico ico_password'></div>
            <input type="password" id="id_inp_password" class='inp_login' placeholder="Contraseña" value=''>
          </div>
